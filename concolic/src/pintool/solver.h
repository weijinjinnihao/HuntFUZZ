...
public:
  ...
  void addHuntJcc(ExprRef, bool, int,int);
...
protected:
  ...
  std::string           distance_file_path_; // for distance calculation
  int                   targetInstLine_; // for distance calculation
  ...
  bool isInterestingHuntJcc(ExprRef, bool, int,int);
